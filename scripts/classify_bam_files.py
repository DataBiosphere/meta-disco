#!/usr/bin/env python3
"""Classify BAM/CRAM files by header inspection.

DEPRECATED: Use scripts/classify_headers.py --type bam instead.
...
from src.meta_disco.file_types import BAM_CONFIG
