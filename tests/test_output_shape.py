...
# grounding. `sample.isoseq.bam` is the golden's own bam input, so the matched `.bai`
...
INDEX_INPUTS = [
    GOLDEN_INPUTS["bam"][0],
    _golden_record("1", file_name="sample.isoseq.bam.bai", file_size=9000, file_format=".bai", entry_id="g-bai-1"),
