...
Classification run: **2026-03-24 23:07:17**
...
| | count | % |
|---|---:|---:|
| **Classified** | 689,313 | 90.9% |
| **Not classified** | 69,344 | 9.1% |
...
| .bam | 311 | No rule determined a value for data_modality |
...
| .bai | 190 | Parent file had no value for data_modality |
...
| | count | % |
|---|---:|---:|
| **Classified** | 125,402 | 16.5% |
| **Not classified** | 633,255 | 83.5% |
...
| .bam | 1,547 | No rule determined a value for assay_type |
...
| .bai | 720 | Parent file had no value for assay_type |
