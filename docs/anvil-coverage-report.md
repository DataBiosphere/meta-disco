...
Classification run: **2026-03-29 23:01:26**
...
|---|---:|---:|---|
| `CHM13` | 409,348 | 54.0% | .vcf.gz (190,224)<br>.tbi (159,059)<br>.csi (37,922)<br>.bed.gz (6,723)<br>.cram (6,718)<br>.crai (6,715)<br>.bam (427)<br>.bed (411)<br>.bai (393)<br>.vcf (208)<br>.txt (199)<br>.gz (193)<br>.bb (89)<br>.tsv (8)<br>.gbwt (6)<br>.snarls (6)<br>.gg (6)<br>.min (6)<br>.xg (6)<br>.dist (6)<br>.fasta (5)<br>.tar.gz (5)<br>.dict (4)<br>.fasta.gz (3)<br>.fa.gz (2)<br>.hal (2)<br>.fa (1)<br>.sizes (1) |
