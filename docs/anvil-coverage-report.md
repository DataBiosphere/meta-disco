...
| | count | % |
|---|---:|---:|
| **Classified** | 688,642 | 90.8% |
| **Not classified** | 70,015 | 9.2% |
...
| .bam | 765 | No rule determined a value for data_modality |
...
| .bai | 407 | Parent file had no value for data_modality |
...
| | count | % |
|---|---:|---:|
| **Classified** | 125,261 | 16.5% |
| **Not classified** | 633,396 | 83.5% |
...
| .bam | 1,623 | No rule determined a value for assay_type |
...
| .bai | 785 | Parent file had no value for assay_type |
