...
Generated 2026-09-17 22:42 by `scripts/compare_corpus.py` (issue #335).

Runs compared: `output/anvil/20260802_170826` → `output/anvil/20260917_204408`.
...
| data_type | 652,265 | 646,169 | 88.9% | 91.2% | -6,096 | 55,947 | 37,548 |
| platform | 57,973 | 57,345 | 7.9% | 8.1% | -628 | 100,137 | 73,749 |
| reference_assembly | 463,794 | 448,738 | 63.2% | 63.4% | -15,056 | 88,571 | 63,329 |
...
| data_type | -6,096 | -25,717 | +0 | +19,621 |
| platform | -628 | -0 | +0 | -628 |
...
| ANVIL_HPRC | data_type | 12,178 | 13,830 | +1,652 |
