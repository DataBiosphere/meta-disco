...
| phs000744 | Yale Center for Mendelian Genomics (YCMG) | 9: ANVIL_CMG_YALE_DS_MC… | 30 | 23359680 (2013) — Recessive loss of function of the neuronal ubiquitin hydrolase UCHL1 l |
...
| phs000925 | PAGE: IPM BioMe Biobank | 1: ANVIL_PAGE_BioMe_GRU_WGS | 22 | 21573225 (2011) — Genetic background of patients from a university medical center in Man |
| phs000971 | The ClinSeq Project: Piloting Large-Scale Genome Sequencing  | 1: ANVIL_CSER_ClinSeq_GRU | 39 | 19602640 (2009) — The ClinSeq Project: piloting large-scale genome sequencing for resear |
...
| phs001222 | CCDG - Whole Genome Sequencing in Type 1 Diabetes (T1DGC) | 1: ANVIL_ccdg_washu_ai_t1d_t1dgc_wgs | 3 | 19430480 (2009) — Genome-wide association study and meta-analysis find that over 40 loci |
...
| phs001259 | CCDG CVD: VIRGO - Variation in Recover-Role of Gender on Out | 1: ANVIL_CCDG_Broad_CVD_EOCAD_VIRGO_W… | 12 | 25271209 (2014) — Effect of low perceived social support on health outcomes in young pat |
| phs001272 | Broad Institute Center for Mendelian Genomics | 9: ANVIL_CMG_Broad_Blood_Gazda_WES… | 0 | Selected Publications empty |
| phs001300 | NABEC: North American Brain Expression Consortium | 1: AnVIL_NIA_CARD_LR_WGS_NABEC_GRU_V2 | 48 | 20485568 (2010) — Abundant quantitative trait loci exist for DNA methylation and gene ex |
| phs001398 | Center for Common Disease Genomics [CCDG] - Cardiovascular:  | 2: ANVIL_CCDG_Broad_CVD_Stroke_BRAVE_… | 0 | Selected Publications empty |
...
| phs001489 | Center for Common Disease Genomics [CCDG] - Neuropsychiatric | 149: ANVIL_CCDG_Broad_NP_Epilepsy_AUSAL… | 4 | 31327507 (2019) — Ultra-Rare Genetic Variation in the Epilepsies: A Whole-Exome Sequenci |
| phs001579 | Center for Common Disease Genomics (CCDG)-Cardiovascular: ME | 1: ANVIL_CCDG_WashU_CVD_EOCAD_METSIM_… | 0 | no dbGaP FTP directory (HTTP 404) |
| phs001584 | eMERGE Network Phase III: HRC Imputed Array Data | 10: ANVIL_eMERGE_GWAS_DS_CHILDD… | 37 | 17903304 (2007) — Framingham Heart Study 100K project: genome-wide associations for card |
| phs001585 | Identification of ALS Associated Genes Using Whole Genome Se | 1: ANVIL_ALS_FTD_ALS_AssociatedGenes_… | 1 | 27455347 (2016) — NEK1 variants confer susceptibility to amyotrophic lateral sclerosis. |
| phs001592 | Center for Common Disease Genomics [CCDG] - Cardiovascular A | 1: ANVIL_CCDG_Broad_MI_ATVB_DS_CVD_WE… | 0 | Selected Publications empty |
| phs001616 | eMERGE Network Phase III Clinical Sequencing: eMERGEseq Pane | 9: ANVIL_eMERGE_eMERGEseq_GRU… | 0 | Selected Publications empty |
| phs001642 | Center for Common Disease Genomics [CCDG] - Autoimmune: Infl | 67: ANVIL_CCDG_Broad_AI_IBD_Brant_HMB_… | 0 | Selected Publications empty |
| phs001676 | CCDG- Neuropsychiatric: Autism - Simons Simplex Collection ( | 1: ANVIL_CCDG_NYGC_NP_Autism_SSC_WGS | 13 | 28630308 (2017) — Measuring shared variants in cohorts of discordant siblings with appli |
| phs001740 | CCDG- Neuropsychiatric: Autism- Study of Autism Genetics Exp | 1: ANVIL_CCDG_NYGC_NP_Autism_SAGE_WGS | 13 | 28630308 (2017) — Measuring shared variants in cohorts of discordant siblings with appli |
| phs001741 | CCDG- Neuropsychiatric: Autism- The Autism Simplex Collectio | 1: ANVIL_ccdg_nygc_np_autism_tasc_wgs | 13 | 28630308 (2017) — Measuring shared variants in cohorts of discordant siblings with appli |
| phs001746 | A Genomic Atlas of Systemic Interindividual Epigenetic Varia | 1: ANVIL_GTEx_BCM_GRU_CoRSIVs | 3 | 34341337 (2021) — A machine learning case-control classifier for schizophrenia based on  |
| phs001766 | CCDG-Neuropsychiatric: Autism- Autism Genetic Resource Excha | 1: ANVIL_CCDG_NYGC_NP_Autism_AGRE_WGS | 13 | 28630308 (2017) — Measuring shared variants in cohorts of discordant siblings with appli |
...
| phs002032 | Genetic Neuroscience: How Human Genes and Alleles Shape Neur | 4: ANVIL_NIMH_Broad_ConvergentNeuro_M… | 2 | 36796362 (2023) — Natural variation in gene expression and viral susceptibility revealed |
...
| phs002042 | CCDG Neuropsychiatric: Autism Center of Excellence (ACE II) | 2: ANVIL_CCDG_NYGC_NP_Autism_ACE2_DS_… | 13 | 28630308 (2017) — Measuring shared variants in cohorts of discordant siblings with appli |
| phs002043 | CCDG Neuropsychiatric: Multimodal Developmental Neurogenetic | 2: ANVIL_CCDG_NYGC_NP_Autism_PELPHREY… | 13 | 28630308 (2017) — Measuring shared variants in cohorts of discordant siblings with appli |
...
| phs002236 | Center for Common Disease Genomics [CCDG] - Cardiovascular:  | 2: ANVIL_CCDG_Broad_CVD_AF_GAPP_DS_MD… | 0 | Selected Publications empty |
| phs002242 | Center for Common Disease Genomics [CCDG] - Cardiovascular:  | 2: ANVIL_CCDG_Broad_CVD_AF_Swiss_Case… | 2 | 17903304 (2007) — Framingham Heart Study 100K project: genome-wide associations for card |
...
| phs002502 | Center for Common Disease Genomics [CCDG] Neuropsychiatric:  | 34: ANVIL_ccdg_asc_ndd_daly_talkowski_… | 7 | 31981491 (2020) — Large-Scale Exome Sequencing Study Implicates Both Developmental and F |
...
| phs003047 | NHGRI GREGoR Consortium: Genomics Research to Elucidate the  | 9: ANVIL_GREGoR_R01_HMB… | 2 | 41224980 (2025) — GREGoR: accelerating genomics for rare diseases. |
...
| phs003499 | Center for Common Disease Genomics (CCDG) - Cardiovascular:  | 2: ANVIL_CCDG_WashU_CVD_MultiEthnic_W… | 0 | Selected Publications empty |
...
| phs004058 | A Depression and Opioid Pragmatic Trial in Pharmacogenetics  | 2: AnVIL_ADOPT_PGx_Acute_Pain_GRU_R1… | 2 | 35899435 (2022) — Implementing a pragmatic clinical trial to tailor opioids for acute pa |
