...
1. **Classification**: A deterministic tiered rule engine (`src/meta_disco/`, with rules bundled as package data in `meta_disco.rules`) that classifies biological data files across six metadata dimensions from their names, extensions, and headers.
